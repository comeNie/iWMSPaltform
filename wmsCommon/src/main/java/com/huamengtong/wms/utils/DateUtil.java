...
import com.huamengtong.wms.enums.DateStyleEnum;
import com.huamengtong.wms.enums.WeekEnum;
...
public class DateUtil {
    ...
    public static long stringToTimestamp(String dateInput, String format) {
    ...
    private static String addInteger(String date, int dateType, int amount) {
        ...
        DateStyleEnum DateStyleEnum = getDateStyleEnum(date);
     ...
     * @return 日期风格
     */
    public static DateStyleEnum getDateStyleEnum(String date) {
        ...
        for (DateStyleEnum style : DateStyleEnum.values()) {
            ...
            if (date != null) {
                try {
                    ...
                    _log.error("Date conversion exception.");
                }
            }
            if (dateTmp != null) {
     ...
     * @return 新日期字符串
     */
    public static String dtringToString(String date, String newPattern) {
        DateStyleEnum oldDateStyleEnum = getDateStyleEnum(date);
        return stringToString(date, oldDateStyleEnum, newPattern);
    }
     ...
     * @return 新日期字符串
     */
    public static String stringToString(String date, DateStyleEnum newDateStyleEnum) {
        DateStyleEnum oldDateStyleEnum = getDateStyleEnum(date);
        return stringToString(date, oldDateStyleEnum, newDateStyleEnum);
    }
     ...
     * @return 新日期字符串
     */
    public static String stringToString(String date, String olddPattern, DateStyleEnum newDateStyleEnum) {
        String dateString = null;
        if (newDateStyleEnum != null) {
            dateString = stringToString(date, olddPattern, newDateStyleEnum.getValue());
        }
        return dateString;
    }
     ...
     * @return 星期
     */
    public static WeekEnum getWeekEnum(String date) {
        WeekEnum WeekEnum = null;
        DateStyleEnum DateStyleEnum = getDateStyleEnum(date);
        if (DateStyleEnum != null) {
            Date myDate = stringToDate(date, DateStyleEnum);
            WeekEnum = getWeekEnum(myDate);
        }
        return WeekEnum;
    }
    ...
    public static WeekEnum getWeekEnum(Date date) {
        ...
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        int WeekEnumNumber = calendar.get(Calendar.DAY_OF_WEEK) - 1;
        switch (WeekEnumNumber) {
            case 0:
