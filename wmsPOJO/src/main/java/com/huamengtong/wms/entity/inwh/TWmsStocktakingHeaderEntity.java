 ...
 */
public class TWmsStocktakingHeaderEntity extends BasePO implements Serializable {
    ...
    public String toString() {
        return "TWmsStocktakingHeaderEntity{" +
                "id=" + id +
                ", tenantId=" + tenantId +
