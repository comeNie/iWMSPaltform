 ...
 */
public class TWmsDnDetailDTO extends BasePO implements Serializable {
    private Long id;
    ...
    public void setStorageRoomIds(Long[] storageRoomIds){this.storageRoomIds = storageRoomIds;}
